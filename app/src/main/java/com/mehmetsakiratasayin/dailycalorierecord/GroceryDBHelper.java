...
import com.mehmetsakiratasayin.dailycalorierecord.GroceryContract.*;
public class GroceryDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_GROCERYLIST_TABLE = "CREATE TABLE " +
                ...
                GroceryEntry.COLUMN_PLUS + " TEXT NOT NULL, " +
                GroceryEntry.COLUMN_SOUR + " TEXT NOT NULL, " +
                GroceryEntry.COLUMN_STATUS + " TEXT NOT NULL, " +
